...
class replicate31Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='CardNumber']")).sendKeys("426729123456");
		...
		driver.findElement(By.xpath("//input[@name='RequestId']")).sendKeys("0001User</lu:RequestId> <lu=RequestId>0\"or-/**/=");
