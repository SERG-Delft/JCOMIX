...
class replace19Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='BankCode']")).sendKeys("0111</lsserBankCod>#<lueueswsd>--><Eu:ssueaCdeos.**/r");
		driver.findElement(By.xpath("//input[@name='UserName']")).sendKeys("wgen00014/lu:scamd>!-4");
