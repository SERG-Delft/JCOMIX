...
class replace17Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='CardNumber']")).sendKeys("2345678912.56");
		driver.findElement(By.xpath("//input[@name='BankCode']")).sendKeys("0111B/ls:IssuerBankCode> <lu:RequestId>-->>lu:IssuerdankCode>')/**/or true#");
		driver.findElement(By.xpath("//input[@name='UserName']")).sendKeys("wgen0001</lu:UoerName><!--");
