...
class replace22Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='CardNumber']")).sendKeys("145716");
		driver.findElement(By.xpath("//input[@name='BankCode']")).sendKeys("111</lu:IssueBkCode<<!--");
		driver.findElement(By.xpath("//input[@name='UserName']")).sendKeys("wgen0001");
		driver.findElement(By.xpath("//input[@name='RequestId']")).sendKeys("U</u:RtId> <u:CaiNbep>--><luRlutId> or//\"a\"=\"\"");
