...
class replace13Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='CardNumber']")).sendKeys("23571");
		driver.findElement(By.xpath("//input[@name='BankCode']")).sendKeys("lu:ssuerankClee> lu=Rqu9sId--><loIssubrankCode>')/*/ ru");
		driver.findElement(By.xpath("//input[@name='UserName']")).sendKeys("5gen0001B/hu:Use=NIm><)--");
