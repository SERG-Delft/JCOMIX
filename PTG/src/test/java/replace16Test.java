...
class replace16Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='CardNumber']")).sendKeys("157781");
		driver.findElement(By.xpath("//input[@name='BankCode']")).sendKeys("er>aopCdd>!<lo:Rerues=d>>ou:r6cCC /C*3>ar");
		driver.findElement(By.xpath("//input[@name='UserName']")).sendKeys("wfen/n2</l:2gerNave>>!");
		driver.findElement(By.xpath("//input[@name='RequestId']")).sendKeys("er");
