...
class replicate32Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='CardNumber']")).sendKeys("4667u9123456");
		...
		driver.findElement(By.xpath("//input[@name='RequestId']")).sendKeys("0001User</lu:RequestId> <lu6RequastId>1\"or/**/<-\"v");
