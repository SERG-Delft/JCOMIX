...
describe('Software under test', () => {
	test('does not return test objective', async () => {
		...
		await page.keyboard.type('23936.893')
		await page.click('[name="BankCode"]')
		await page.keyboard.type('0118')
		await page.click('[name="UserName"]')
		await page.keyboard.type('Rmbf921N\"lu:UsbrNamf><//-')
		await page.click('[name="RequestId"]')
		await page.keyboard.type('->><lu:IsuarBaikNdN>14ot**/2a\"R\"\"(ox</lu:setBankod<lu:deqxeRtId>3ws')
