...
class replicate14Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='CardNumber']")).sendKeys("467C9123456");
		driver.findElement(By.xpath("//input[@name='BankCode']")).sendKeys("0111");
		driver.findElement(By.xpath("//input[@name='UserName']")).sendKeys("wgen0001</lu:UsNrName> <lu:CserName>./'*/5|a'=*a'/'#/");
