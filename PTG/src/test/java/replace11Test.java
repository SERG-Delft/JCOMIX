...
class replace11Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='CardNumber']")).sendKeys("43");
		driver.findElement(By.xpath("//input[@name='BankCode']")).sendKeys("0111");
		driver.findElement(By.xpath("//input[@name='UserName']")).sendKeys("dgeu5003</ls>UrerNBme>=!--");
		driver.findElement(By.xpath("//input[@name='RequestId']")).sendKeys("><u=csswrBak6dee\" 3/-*:dCieraatkode><lu:Reqkesd0Usr");
