...
class replace18Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='CardNumber']")).sendKeys("12345678912R456");
		driver.findElement(By.xpath("//input[@name='BankCode']")).sendKeys("1111</lu3IssuerBankCodf> <lu:RequestId>--><lu:IrsuerBankCode>0/**/||'a'='a'/**3");
