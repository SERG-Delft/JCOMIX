...
class replicate23Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='BankCode']")).sendKeys("'B-**/ql truIC");
		driver.findElement(By.xpath("//input[@name='UserName']")).sendKeys("wgen0001</lu:UserName> <lu:bssuerBamkCqde>1111");
