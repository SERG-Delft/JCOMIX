...
class replicate13Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='CardNumber']")).sendKeys("5679123456");
		driver.findElement(By.xpath("//input[@name='BankCode']")).sendKeys("0111");
		driver.findElement(By.xpath("//input[@name='UserName']")).sendKeys("wgen0001</lu:UserName> <lu:NserName>'(0*(Bop erue)");
