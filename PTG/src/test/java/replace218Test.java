...
class replace218Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='BankCode']")).sendKeys("0/11<|Ie1epBa0kCi73!--");
		driver.findElement(By.xpath("//input[@name='UserName']")).sendKeys("wgen0001");
		driver.findElement(By.xpath("//input[@name='RequestId']")).sendKeys("0001Eserr5l:=equestB:>!<lu7CmrcNEgbera<:ReqtestId>0v:os");
