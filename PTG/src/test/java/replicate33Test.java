...
class replicate33Test {
	...
	public void aTest(){
		...
		driver.findElement(By.xpath("//input[@name='CardNumber']")).sendKeys("54678123456");
		...
		driver.findElement(By.xpath("//input[@name='RequestId']")).sendKeys("0001User</lu:RequestId> <lu<equestId>|/**/orr<e");
